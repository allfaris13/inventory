          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-muted/40 border-b border-border">
                ...
                <th className="px-6 py-4 text-[11px] font-bold text-muted-foreground uppercase tracking-widest">Cabang</th>
              ...
              {filtered.map((item: InventoryItem) => {
                ...
                return (
                  <tr key={item.id} className="group hover:bg-muted/10 transition-colors">
                    ...
                    <td className="px-6 py-5 text-[11px] font-black text-foreground uppercase tracking-tighter italic">
